...
class RouterData():
    ...
    def sendData(self, values):
        token_url = "https://10.0.101.240:44323/connect/token"
        activity_api_url = "https://10.0.101.240:44350/api/device/device/list?page=1&items=10&includeUnassigned=true"
